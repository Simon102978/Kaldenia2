        ...
        public TinkerBenchAddon(DirectionType type, int uses)
        {
            switch (type)
            {
                case DirectionType.South:
                    AddCraftComponent(new AddonToolComponent(CraftSystem, 0xA213, 0xA212, 1157072, 1157073, "Station de travail", uses, this), 0, 0, 0);
                    AddComponent(new ToolDropComponent(41489, 1015078), 0, 1, 0);
                    break;
                case DirectionType.East:
                    AddCraftComponent(new AddonToolComponent(CraftSystem, 0xA21B, 0xA21A, 1157072, 1157073, "Station de travail", uses, this), 0, 0, 0);
