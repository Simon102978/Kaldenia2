...
namespace Server.Engines.Quests
{
    public class MadScientistQuest
    {
        ...
        public static readonly SutekIngredientInfo[] m_Ingredients =
        {
            ...
            new SutekIngredientInfo(SutekIngredient.WoodenPalmierBoards,  new Point3D(939, 592, -14),   0x1BDB, 1021189),
            new SutekIngredientInfo(SutekIngredient.WoodenPalmierBoards,  new Point3D(928, 590, -14),   0x1BDC, 1021189),
            new SutekIngredientInfo(SutekIngredient.WoodenPalmierBoards,  new Point3D(911, 591, -14),   0x1BD8, 1021189),
            new SutekIngredientInfo(SutekIngredient.WoodenPalmierBoards,  new Point3D(916, 598, -14),   0x1BD9, 1021189),
