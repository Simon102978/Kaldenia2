...
namespace Server.Engines.Quests
{
    public class ProfessionalBountyQuest : BaseQuest
    {
        ...
        public ProfessionalBountyQuest(BaseGalleon galleon)
        {
            ...
            AddObjective(new BountyQuestObjective());
            AddReward(new BaseReward(1116712)); //The gold listed on the bulletin PalmierBoard and a special reward from the officer if captured alive.
        }
        ...
        public override bool RenderObjective(MondainQuestGump g, bool offer)
        {
            ...
            g.AddHtmlLocalized(98, offset, 312, 16, 1116710, 0x2710, false, false);  // Capture or kill a pirate listed on the bulletin PalmierBoard.
            ...
            g.AddHtmlLocalized(98, offset, 312, 32, 1116712, 0x15F90, false, false); //The gold listed on the bulletin PalmierBoard and a special reward from the officer if captured alive.
