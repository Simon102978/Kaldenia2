...
namespace Server.Spells.Eighth
{
    public class AirElementalSpell : MagerySpell
    {
		...
		public override MagicAptitudeRequirement[] AffinityRequirements { get { return new MagicAptitudeRequirement[] { new MagicAptitudeRequirement(MagieType.Arcane, 14) }; } }
