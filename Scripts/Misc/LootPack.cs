...
namespace Server
{
	...
	//	};
        ...
        public static readonly LootPackItem[] MageryScrollItems = new[]
        {
            ...
            new LootPackItem(typeof(ExplosionScroll), 1), new LootPackItem(typeof(InvisibilityScroll), 1), new LootPackItem(typeof(ChainLightningScroll), 1), new LootPackItem(typeof(MassCurseScroll), 1),
