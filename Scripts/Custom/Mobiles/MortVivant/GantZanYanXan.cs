...
namespace Server.Items
{
    ...
    public class GantZanYanXan : BaseRanged
    {
        ...
        [Constructable]
        public GantZanYanXan()
            : base(0x1450)
        {
            Weight = 6.0;
            Layer = Layer.TwoHanded;
            Name = "Gant de Zan'Yan'Xan";
        ...
        public override bool OnFired(Mobile attacker, IDamageable damageable)
        {
            ...
            damageable.MovingParticles(attacker, 0x377A, 7, 0, false, true, 0xCA, 0, 9502, 4019, 0x160, 0);
        ...
        public GantZanYanXan(Serial serial)
            : base(serial)
        {
        }
