...
{
    public class ChienProfanian : BaseCreature
    {
        private readonly Mobile m_Target;
        private readonly DateTime m_ExpireTime;

        public ChienProfanian(Mobile caster, Mobile target, TimeSpan duration)
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.18, 0.36)
        {
            Name = "Chien des abysses";
            Body = 788;
            Hue = 1401;
        ...
        public ChienProfanian(Serial serial)
            : base(serial)
        { }
