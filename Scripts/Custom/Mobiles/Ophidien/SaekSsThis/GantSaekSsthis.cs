...
namespace Server.Items
{
    ...
    public class GantSaekSsthis : BaseRanged
    {
        ...
        [Constructable]
        public GantSaekSsthis()
            : base(0x1450)
        {
            Weight = 6.0;
            Layer = Layer.TwoHanded;
            Name = "Gant de SaekSsthis";
        ...
        public override bool OnFired(Mobile attacker, IDamageable damageable)
        {
            ...
            attacker.MovingParticles(damageable, 0x36FE, 7, 0, false, true, 0xCA, 0, 9502, 4019, 0x160, 0);
        ...
        public GantSaekSsthis(Serial serial)
            : base(serial)
        {
        }
