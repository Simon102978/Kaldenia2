...
namespace Server.Mobiles
{
    ...
    public class DauphinMalefiqueNoir : BaseCreature
    {
        ...
        public DauphinMalefiqueNoir(Serial serial)
            : base(serial)
        {
        }
       	...
       	public override void AlterMeleeDamageTo(Mobile to, ref int damage)
		{
          ...
          if (Utility.RandomDouble() < 0.10) 
               BleedAttack.BeginBleed(to, this, true);
