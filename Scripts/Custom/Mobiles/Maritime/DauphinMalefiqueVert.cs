...
namespace Server.Mobiles
{
    ...
    public class DauphinMalefiqueVert : BaseCreature
    {
        ...
        public DauphinMalefiqueVert(Serial serial)
            : base(serial)
        {
        }
       	...
       	public override void AlterMeleeDamageTo(Mobile to, ref int damage)
		{
            ...
            if (Utility.RandomDouble() < 0.10) 
                to.ApplyPoison(this, Poison.Lethal);
