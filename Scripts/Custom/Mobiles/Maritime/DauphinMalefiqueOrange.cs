...
namespace Server.Mobiles
{
    ...
    public class DauphinMalefiqueOrange : BaseCreature
    {
        ...
        public DauphinMalefiqueOrange(Serial serial)
            : base(serial)
        {
        }
       	...
       	public override void AlterMeleeDamageTo(Mobile to, ref int damage)
		{
          ...
          if (Utility.RandomDouble() < 0.10) 
             MortalStrike.BeginWound(to, TimeSpan.FromSeconds(20));
