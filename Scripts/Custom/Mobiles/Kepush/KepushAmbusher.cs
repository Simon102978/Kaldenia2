...
namespace Server.Mobiles
{
	...
	public class KepushAmbusher  : KepushBase
	{
        ...
        [Constructable]
        public KepushAmbusher () : base(AIType.AI_Melee , FightMode.Closest, 10, 1, 0.2, 0.4)
        {
	...
	//		Hue = Utility.RandomSkinHue();
        ...
        public KepushAmbusher (Serial serial) : base(serial)
        {
        }
