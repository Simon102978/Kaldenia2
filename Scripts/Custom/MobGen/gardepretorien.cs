...
{
	[CorpseName("le corps d'un Gardepretorien")]
	public class gardepretorien : BaseCreature
	{
		[Constructable]
		public gardepretorien() : base(AIType.AI_Vendor, FightMode.None, 10, 1, 0.2, 0.4)
		{
			Name = "Gaius Lupus";
			Body = 0x190;
			BaseSoundID = 0;
		...
		public gardepretorien(Serial serial) : base(serial)
		{
		}
