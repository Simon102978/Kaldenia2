...
namespace Server.Gumps
{
  public class GambleGump : Server.Gumps.Gump
  {
    ...
    this.AddLabel(338, 250, 0, @"Votre mise en pi�ces :");
    this.AddLabel(338, 305, 0, @"Votre nombre :");
    this.AddTextEntry(397, 272, 43, 20, 0, 1, @"100");
    this.AddTextEntry(463, 306, 21, 20, 0, 2, @"6");
    this.AddHtml( 303, 68, 210, 172, @"Gagner jusqu'� 4 fois votre mise!<br>Misez et choisissez un nombre de 1 � 6. Si votre nombre est sur 1 des deux d�s, vous gagner 2 fois la mise. S'il est sur les deux d�s, vous gagner 4 fois la mise!<br><br>Sinon, votre or est � moi!", (bool)true, (bool)true);
    }
