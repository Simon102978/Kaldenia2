...
{
	[Flipable]
	public class GantsArchimage : BaseArmor, IArcaneEquip
	{
		...
		[Constructable]
		public GantsArchimage()
			: base(0x13C6)
		{
			Weight = 1.0;
			Name = "Gants de l'Archimage";
		}

		public GantsArchimage(Serial serial)
			: base(serial)
		{
		}
