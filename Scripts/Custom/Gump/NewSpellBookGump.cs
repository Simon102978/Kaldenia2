...
namespace Server.Gumps
{
    ...
    public class NewSpellbookGump : Gump
    {
        public static SpellBookEntry[] m_SpellBookEntry = new SpellBookEntry[]
        {
			...
			new SpellBookEntry( 1, MagieType.Arcane,"Armure réactive", new Type[] {typeof(Garlic), typeof(SpidersSilk), typeof(SulfurousAsh) },0x8c6, 1,766),
			...
			new SpellBookEntry( 3, MagieType.Arcane,"Agilité", new Type[] {typeof(Bloodmoss), typeof(MandrakeRoot) },0x8C8, 2,774),
			new SpellBookEntry( 3, MagieType.Arcane,"Astuce", new Type[] {typeof(MandrakeRoot), typeof(Nightshade) },0x8D9, 2,775),
			new SpellBookEntry( 3, MagieType.Arcane,"Force", new Type[] {typeof(MandrakeRoot), typeof(Nightshade) },0x8CF, 2,776),
			new SpellBookEntry( 4, MagieType.Arcane,"Protection", new Type[] {typeof(Garlic), typeof(Ginseng), typeof(SulfurousAsh) },0x8ce, 2,777),
			new SpellBookEntry( 4, MagieType.Arcane,"Antidote", new Type[] {typeof(Garlic), typeof(Ginseng) },0x8ca, 2,778),
			new SpellBookEntry( 5, MagieType.Arcane,"Malaise", new Type[] {typeof(Nightshade), typeof(SpidersSilk) },0x08e5, 2,779),
			new SpellBookEntry( 3, MagieType.Arcane,"Piège Magique", new Type[] {typeof(Garlic), typeof(SpidersSilk), typeof(SulfurousAsh) },0x8cC, 2,780),
			new SpellBookEntry( 3, MagieType.Arcane,"Sup. De Piège", new Type[] {typeof(Bloodmoss), typeof(SulfurousAsh) },0x8cD, 2,781),
			new SpellBookEntry( 6, MagieType.Arcane,"Fermeture Mag.", new Type[] {typeof(Garlic), typeof(Bloodmoss), typeof(SulfurousAsh) },0x8D2, 3,782),
			new SpellBookEntry( 6, MagieType.Arcane,"Crochetage", new Type[] {typeof(Bloodmoss), typeof(SulfurousAsh) },0x8d6, 3,783),
			new SpellBookEntry( 7, MagieType.Arcane,"Télékinésie", new Type[] {typeof(Bloodmoss), typeof(MandrakeRoot) },0x8d4, 3,784),
			new SpellBookEntry( 8, MagieType.Arcane,"Téléportation", new Type[] {typeof(Bloodmoss), typeof(MandrakeRoot) },0x8d5, 3,785),
			new SpellBookEntry( 10, MagieType.Arcane,"Rappel", new Type[] {typeof(BlackPearl), typeof(Bloodmoss), typeof(MandrakeRoot) },0x8df, 4,786),
			new SpellBookEntry( 12, MagieType.Arcane,"Souffle d'esprit", new Type[] {typeof(BlackPearl), typeof(MandrakeRoot), typeof(Nightshade)},0x8e4, 5,787),
			new SpellBookEntry( 6, MagieType.Arcane,"Boule de feu", new Type[] {typeof(BlackPearl) },0x8d1, 3,788),      		
            new SpellBookEntry( 9, MagieType.Arcane,"Sommeil de masse", new Type[] {typeof(Ginseng), typeof(Nightshade), typeof(SpidersSilk)},24009, 5,857),
			new SpellBookEntry( 11, MagieType.Arcane,"Bombardement", new Type[] {typeof(Bloodmoss), typeof(Garlic), typeof(SulfurousAsh)},24011, 6,688),      
            new SpellBookEntry( 16, MagieType.Arcane,"Élém. : Feu", new Type[] {typeof(Bloodmoss), typeof(MandrakeRoot), typeof(SpidersSilk)},0x8fe, 8,789),
			new SpellBookEntry( 15, MagieType.Arcane,"Élém. : Terre", new Type[] {typeof(Bloodmoss), typeof(MandrakeRoot), typeof(SpidersSilk) },0x8fd, 8,790),
			new SpellBookEntry( 14, MagieType.Arcane,"Élém. : Air", new Type[] {typeof(Bloodmoss), typeof(MandrakeRoot), typeof(SpidersSilk) },0x8fb, 8,791),
			new SpellBookEntry( 13, MagieType.Arcane,"Élém. : Eau", new Type[] {typeof(Bloodmoss), typeof(MandrakeRoot), typeof(SpidersSilk) },0x8ff, 8,840),
            ...
            new SpellBookEntry( 11, MagieType.Cycle,"Éclair en série", new Type[] {typeof(BlackPearl), typeof(SulfurousAsh), typeof(MandrakeRoot) },2288, 7,802),
