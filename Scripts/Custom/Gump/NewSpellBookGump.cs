...
namespace Server.Gumps
{
    ...
    public class NewSpellbookGump : Gump
    {
        public static SpellBookEntry[] m_SpellBookEntry = new SpellBookEntry[]
        {
			...
			new SpellBookEntry( 5, MagieType.Arcane,"Télékinésie", new Type[] {typeof(Bloodmoss), typeof(MandrakeRoot) },0x8d4, 3,784),
			...
			new SpellBookEntry( 8, MagieType.Arcane,"Boule de feu", new Type[] {typeof(BlackPearl) },0x8d1, 3,788),
