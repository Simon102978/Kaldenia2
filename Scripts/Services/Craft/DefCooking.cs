...
AddBeverageRes(index, BeverageType.Water, 1, "Vous avez besoin d'un pichet d'eau avec 1 charge");
			...
			index = AddCraft(typeof(JarHoney), "Ingrédients humides", "Miel", 10.0, 50.0, typeof(HoneyComb), "Rayon de Miel", 5, "Vous n'avez pas suffisament de rayon de miel");
			SetItemHue(index, 0x457);
			...
			#region Volaille
			index = AddCraft(typeof(CookedBird), "Viandes", "Volaille cuite", 0.0, 70.0, typeof(RawBird), "Volaille cru", 1, 1044253);
