...
namespace Server.Engines.Craft
{
	public enum TailorRecipe
	{
		...
		[Description("Jupe Provocante à Volants")]
		Jupe8 = 20001,

		[Description("Jupe à Jartelles")]
		Jupe10 = 20002,

		[Description("manteau Doré")]
		ManteauDore = 20003,

		[Description("manteau Voyageur")]
		ManteauVoyageur = 20004,


		[Description("Robe Nim")]
		RobeNim = 20005,

		[Description("Robe Bleue Décoltée")]
		RobeBleudecolte = 20006,


		[Description("Pantalons amples")]
		Pantalon1 = 20007,

		[Description("Pantalons à Fourrure")]
		Pantalon3 = 20008,


		[Description("Cape Paon")]
		CapePaon = 20009,

		[Description("Bandeau Oeil")]
		CacheOeil3 = 20010,
	...
	Mobile from, bool failed, bool lostMaterial, bool toolBroken, int quality, bool makersMark, CraftItem item)
		...
		public override void InitCraftList()
		{
			...
			index = AddCraft(typeof(JupeCourte4), "Jupes", "Jupe Barbare", 10.0, 30.0, typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(JupeCourte6), "Jupes", "Jupe Courte à Vollant Unie", 10.0, 30.0, typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			...
			index = AddCraft(typeof(PareoCourt), "Jupes", "Paréo", 30.0, 50.0, typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Pareo), "Jupes", "Jupe Ouverte", 35.0, 55.0, typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Jupe4), "Jupes", "Jupe Artisane",  40.0, 60.0, typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			...
			index = AddCraft(typeof(Jupe2), "Jupes", "Jupe Délicate", 55.0, 75.0, typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(JupeCourte7), "Jupes", "Jupe Courte Droite", 60.0, 80.0, typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");	
			index = AddCraft(typeof(JupeCourte), "Jupes", "Jupe Courte Lacée",60.0, 80.0 , typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");	
			...
			index = AddCraft(typeof(PareoTissuSimple), "Jupes", "Paréo en Tissu Simple", 65.0, 95.0, typeof(Cloth), "Tissus", 6, "Vous n'avez pas assez de tissus.");
			...
			index = AddCraft(typeof(Jupe7), "Jupes", "Jupe Provocante",65.0, 85.0 , typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Jupe9), "Jupes", "Jupe à Saccoche",70.0, 90.0, typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(JupeOndule2), "Jupes", "Jupe Ondulée froufrou", 75.0, 95.0, typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Jupe11), "Jupes", "Jupe Sombre", 80.0, 100.0, typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(JupeVoiles), "Jupes", "Jupe à Banquet", 80.0, 100.0, typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Jupe8), "Jupes", "Jupe Provocante à Volants",85.0, 105.0, typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			AddRecipe(index, (int)TailorRecipe.Jupe8);

			index = AddCraft(typeof(Jupe10), "Jupes", "Jupe à Jartelles",90.0, 110.0, typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			AddRecipe(index, (int)TailorRecipe.Jupe10);
			...
			index = AddCraft(typeof(Camisole), "Hauts", "Chandail de travail", 10.0, 30.0, typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Doublet), "Hauts", "Doublet",10.0, 30.0 , typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			...
			index = AddCraft(typeof(Chandail4), "Hauts", "Chandail ample",20.0, 40.0 , typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");	
			index = AddCraft(typeof(Chemise4), "Hauts", "Chemise simple", 20.0, 40.0, typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(SoutienGorgeEchancre), "Hauts", "Soutien-Gorge Échancré", 20.0, 50.0, typeof(Cloth), "Tissus", 4, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Chandail9), "Hauts", "Chandail bouffant", 20.0, 40.0, typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			...
			index = AddCraft(typeof(Chandail5), "Hauts", "Chandail propre", 30.0, 50.0, typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			...
			index = AddCraft(typeof(Chemise5), "Hauts", "Chemise ajustée",30.0, 50.0 , typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(ChemiseDecoree), "Hauts", "Chemise Décorée", 30.0, 70.0, typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(SoutienGorgeTissu), "Hauts", "Soutien-Gorge en Tissu", 30.0, 60.0, typeof(Cloth), "Tissus", 4, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Chandail8), "Hauts", "Chandail Manche Longue", 30.0, 50.0, typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Tabar4), "Hauts", "Tabar sombre", 40.0, 60.0, typeof(Cloth), "Tissus", 12, "Vous n'avez pas assez de tissus.");
			...
			index = AddCraft(typeof(TuniqueDoree), "Hauts", "Tunique Dorée", 45.0, 75.0, typeof(Cloth), "Tissus", 10, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(TuniqueCombat), "Hauts", "Tunique de Combat", 45.0, 75.0, typeof(Cloth), "Tissus", 10, "Vous n'avez pas assez de tissus.");
			...
			index = AddCraft(typeof(Chemise7), "Hauts", "Manteau élégant", 50.0, 70.0, typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Doublet3), "Hauts", "Doublet lacé",  55.0, 75.0, typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");		
			...
			index = AddCraft(typeof(ManteauBourgeois), "Hauts", "Manteau Bourgeois", 55.0, 90.0, typeof(Cloth), "Tissus", 12, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(ManteauVoyageur), "Hauts", "Manteau Voyageur", 55.0, 90.0, typeof(Cloth), "Tissus", 12, "Vous n'avez pas assez de tissus.");
			AddRecipe(index, (int)TailorRecipe.ManteauVoyageur);
			...
			index = AddCraft(typeof(Chandail2), "Hauts", "Tunique ornée",60.0, 80.0 , typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			...
			index = AddCraft(typeof(Corsage), "Hauts", "Corsage", 60.0, 100.0, typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			...
			index = AddCraft(typeof(Chemise3), "Hauts", "Chemise longue lacée",65.0, 85.0 , typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Tabar9), "Hauts", "Grand tabar ouvert",65.0, 85.0 , typeof(Cloth), "Tissus", 12, "Vous n'avez pas assez de tissus.");	
			index = AddCraft(typeof(Tabar3), "Hauts", "Tabar à cape", 65.0, 85.0, typeof(Cloth), "Tissus", 12, "Vous n'avez pas assez de tissus.");
			...
			index = AddCraft(typeof(ManteauDore), "Hauts", "Manteau Doré", 70.0, 90.0, typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			AddRecipe(index, (int)TailorRecipe.ManteauDore);


			index = AddCraft(typeof(Uniforme), "Hauts", "Manteau d'uniforme", 75.0, 95.0, typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Veste2), "Hauts", "Veste manche courte", 75.0, 95.0, typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Tunique6), "Hauts", "Tunique à voilant",75.0, 95.0, typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");	
			index = AddCraft(typeof(Doublet2), "Hauts", "Doublet à épaulette", 75.0, 95.0, typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Tunique5), "Hauts", "Tunique sans manche",75.0, 95.0 , typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");		
			index = AddCraft(typeof(Tunique7), "Hauts", "Tunique propre", 75.0, 95.0, typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");	
			...
			index = AddCraft(typeof(Veste3), "Hauts", "Manteau Propre", 80.0, 100.0, typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(CorsetCuir), "Hauts", "Corset de Cuir",85.0, 105.0, typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			...
			index = AddCraft(typeof(Robe10), "Robes", "Robe manches amples",10.0, 30.0 , typeof(Cloth), "Tissus", 16, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Robe7), "Robes", "Robe Simple", 15.0, 35.0, typeof(Cloth), "Tissus", 16, "Vous n'avez pas assez de tissus.");	
			index = AddCraft(typeof(Robe15), "Robes", "Robe légère", 20.0, 40.0, typeof(Cloth), "Tissus", 16, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Robe8), "Robes", "Robe lacée large",20.0, 40.0 , typeof(Cloth), "Tissus", 16, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Robe6), "Robes", "Robe à volants", 30.0, 50.0, typeof(Cloth), "Tissus", 16, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(FemaleElvenRobe), "Robes", "Grande Robe Toge",35.0, 55.0 , typeof(Cloth), "Tissus", 30, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Robe19), "Robes", "Robe sans manche", 40.0, 60.0, typeof(Cloth), "Tissus", 16, "Vous n'avez pas assez de tissus.");	
			index = AddCraft(typeof(Robe14), "Robes", "Robe Provocante délicate", 40.0, 60.0, typeof(Cloth), "Tissus", 16, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Robe3), "Robes", "Robe manches courtes", 40.0, 60.0, typeof(Cloth), "Tissus", 16, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Robe9), "Robes", "Robe d'érudit", 45.0, 65.0, typeof(Cloth), "Tissus", 16, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(RobeMoulante), "Robes", "Robe Moulante", 50.0, 70.0, typeof(Cloth), "Tissus", 16, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(RobeNim), "Robes", "Robe Nimunique",50.0, 70.0 , typeof(Cloth), "Tissus", 16, "Vous n'avez pas assez de tissus.");
			AddRecipe(index, (int)TailorRecipe.RobeNim);


			index = AddCraft(typeof(Robe5), "Robes", "Robe artisane",50.0, 70.0 , typeof(Cloth), "Tissus", 16, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(RobeVoyage), "Robes", "Robe de Voyage", 50.0, 90.0, typeof(Cloth), "Tissus", 14, "Vous n'avez pas assez de tissus.");
			...
			AddRecipe(index, (int)TailorRecipe.RobeBleudecolte);
			...
			index = AddCraft(typeof(RobeCourte), "Robes", "Robe Courte", 60.0, 80.0, typeof(Cloth), "Tissus", 16, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(RobeDoree), "Robes", "Robe Dorée", 60.0, 80.0, typeof(Cloth), "Tissus", 16, "Vous n'avez pas assez de tissus.");	
			index = AddCraft(typeof(RobeProvocante), "Robes", "Robe Sombre", 60.0, 80.0, typeof(Cloth), "Tissus", 16, "Vous n'avez pas assez de tissus.");
			...
			index = AddCraft(typeof(Robe11), "Robes", "Robe Délicate sombre", 65.0, 85.0, typeof(Cloth), "Tissus", 16, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Robe18), "Robes", "Robe à Col", 65.0, 85.0, typeof(Cloth), "Tissus", 16, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(RobeNobleDecolte), "Robes", "Robe Noble Decoltée", 70.0, 90.0, typeof(Cloth), "Tissus", 16, "Vous n'avez pas assez de tissus.");
			...
			index = AddCraft(typeof(RobeVoyage2), "Robes", "Robe de Voyage 2", 70.0, 110.0, typeof(Cloth), "Tissus", 14, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(RobeProvocante2), "Robes", "Robe Provocante ornée",75.0, 95.0 , typeof(Cloth), "Tissus", 16, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Robe12), "Robes", "Robe délicate", 80.0, 100.0, typeof(Cloth), "Tissus", 16, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Robe16), "Robes", "Robe provocante Sombre", 80.0, 100.0, typeof(Cloth), "Tissus", 16, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(RobeProvocante6), "Robes", "Robe dorée", 80.0, 100.0, typeof(Cloth), "Tissus", 16, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Robe13), "Robes", "Robe Ouverte", 80.0, 100.0, typeof(Cloth), "Tissus", 16, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Robe2), "Robes", "Robe provocante", 85.0, 105.0, typeof(Cloth), "Tissus", 16, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(RobeProvocante3), "Robes", "Robe dorée sombre", 85.0, 105.0, typeof(Cloth), "Tissus", 16, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(RobeProvocante5), "Robes", "Robe provocante légère", 90.0, 110.0, typeof(Cloth), "Tissus", 16, "Vous n'avez pas assez de tissus.");

			index = AddCraft(typeof(Robe), "Toges", "Toge Simple", 35.0, 70.0, typeof(Cloth), "Tissus", 16, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Toge), "Toges", "Toge Souple", 40.0, 75.0, typeof(Cloth), "Tissus", 18, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Toge3), "Toges", "Toge à épaulettes", 55.0, 75.0, typeof(Cloth), "Tissus", 18, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Toge6), "Toges", "Toge à ceinture dorée", 55.0, 75.0, typeof(Cloth), "Tissus", 18, "Vous n'avez pas assez de tissus.");
			...
			index = AddCraft(typeof(Manteau), "Toges", "Toge ornée", 65.0, 85.0, typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Toge7), "Toges", "Toge en voile", 70.0, 90.0, typeof(Cloth), "Tissus", 18, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Toge8), "Toges", "Toge Sombre", 70.0, 90.0, typeof(Cloth), "Tissus", 18, "Vous n'avez pas assez de tissus.");

			index = AddCraft(typeof(ShortPants), "Pantalons", "Short Taille Haute", 10.0, 50.0, typeof(Cloth), "Tissus", 6, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Kilt), "Pantalons", "Kilt", 15.0, 55.0, typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(LongPants), "Pantalons", "Pantalon Taille Haute", 20.0, 70.0, typeof(Cloth), "Tissus", 8, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Pantalon7), "Pantalons", "Short Droit", 35.0, 75.0, typeof(Cloth), "Tissus", 12, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Pantalon8), "Pantalons", "Short Ample", 45.0, 75.0, typeof(Cloth), "Tissus", 12, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Pantalon4), "Pantalons", "Pantalon à Poches", 55.0, 75.0, typeof(Cloth), "Tissus", 12, "Vous n'avez pas assez de tissus.");
			...
			AddRecipe(index, (int)TailorRecipe.Pantalon1);
			...
			AddRecipe(index, (int)TailorRecipe.Pantalon3);




			index = AddCraft(typeof(SkullCap), "Chapeaux", "Bandana", 0.0, 20.0, typeof(Cloth), "Tissus", 2, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Bandana), "Chapeaux", "Bandeau", 10.0, 30.0, typeof(Cloth), "Tissus", 2, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(WizardsHat), "Chapeaux", "Chapeau de sorcier", 10.0, 30.0, typeof(Cloth), "Tissus", 15, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(TallStrawHat), "Chapeaux", "Grand chapeau de paille",15.0, 35.0 , typeof(Cloth), "Tissus", 13, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(JesterHat), "Chapeaux", "Chapeau de bouffon", 20.0, 40.0, typeof(Cloth), "Tissus", 15, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Bonnet), "Chapeaux", "Bonnet",20.0, 40.0, typeof(Cloth), "Tissus", 11, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(FeatheredHat), "Chapeaux", "Chapeau à plume",30.0, 50.0, typeof(Cloth), "Tissus", 12, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(ChapeauMage), "Chapeaux", "majisto", 35.0, 55.0, typeof(Cloth), "Tissus", 6, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(TricorneHat), "Chapeaux", "Chapeau Tricorne",40.0, 60.0 , typeof(Cloth), "Tissus", 12, "Vous n'avez pas assez de tissus.");
			...
			index = AddCraft(typeof(StrawHat), "Chapeaux", "Chapeau de paille", 45.0, 65.0, typeof(Cloth), "Tissus", 10, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(FloppyHat), "Chapeaux", "Chapeau", 45.0, 65.0, typeof(Cloth), "Tissus", 11, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Cap), "Chapeaux", "Petit Chapeau", 50.0, 70.0, typeof(Cloth), "Tissus", 11, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(WideBrimHat), "Chapeaux", "Petit chapeau de paille", 50.0, 70.0, typeof(Cloth), "Tissus", 12, "Vous n'avez pas assez de tissus.");			
			...
			index = AddCraft(typeof(ChapeauPlume3), "Chapeaux", "Chapeau à Plume", 55.0, 75.0, typeof(Cloth), "Tissus", 6, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(CoiffeEgypte), "Chapeaux", "Coiffe Égyptienne",60.0, 80.0 , typeof(Cloth), "Tissus", 6, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Chale1), "Chapeaux", "Chale voilé", 60.0, 80.0, typeof(Cloth), "Tissus", 6, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(ChapeauMousquetaire), "Chapeaux", "Chapeau Mousquetaire",60.0, 80.0 , typeof(Cloth), "Tissus", 6, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(ChapeauToc), "Chapeaux", "Petite Toque", 60.0, 80.0, typeof(Cloth), "Tissus", 6, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(ChapeauPlume2), "Chapeaux", "Chapeau à Plume Courte",  60.0, 80.0, typeof(Cloth), "Tissus", 6, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(ChapeauPirate), "Chapeaux", "Chapeau de Pirate", 65.0, 85.0, typeof(Cloth), "Tissus", 6, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Capuche1), "Chapeaux", "Capuche",65.0, 85.0 , typeof(Cloth), "Tissus", 6, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Capuche), "Chapeaux", "Capuche", 65.0, 85.0, typeof(Cloth), "Tissus", 6, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(ChapeauPlume1), "Chapeaux", "Chapeau à Plume Longue",70.0, 90.0,  typeof(Cloth), "Tissus", 6, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(ToquePlume), "Chapeaux", "Toque à Plume", 70.0, 90.0, typeof(Cloth), "Tissus", 6, "Vous n'avez pas assez de tissus.");
			...
			index = AddCraft(typeof(Cloak), "Capes", "Cape Simple", 35.0, 55.0, typeof(Cloth), "Tissus", 14, "Vous n'avez pas assez de tissus.");
			...
			index = AddCraft(typeof(Cape3), "Capes", "Cape à voiles",50.0, 70.0 , typeof(Cloth), "Tissus", 12, "Vous n'avez pas assez de tissus.");
			...
			AddRecipe(index, (int)TailorRecipe.CapePaon);
			...
			index = AddCraft(typeof(Cape2), "Capes", "Cape à plumes", 85.0, 105.0, typeof(Cloth), "Tissus", 12, "Vous n'avez pas assez de tissus.");
			index = AddCraft(typeof(Cape9), "Capes", "Demi cape Distinguée", 85.0, 105.0, typeof(Cloth), "Tissus", 12, "Vous n'avez pas assez de tissus.");
			...
			AddRecipe(index, (int)TailorRecipe.CacheOeil3);
