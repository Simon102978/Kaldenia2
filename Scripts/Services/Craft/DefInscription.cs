...
namespace Server.Engines.Craft
{
    ...
    public class DefInscription : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
			...
			index = AddCraft(typeof(MassSleepScroll),"Arcane","Sommeil de masse", 46.4, 96.4, typeof(BlankScroll), 1044377, 1, 1044378);
			AddRes(index, typeof(SpidersSilk),"SpidersSilk", 1,"Vous n'avez pas assez de SpidersSilk.");
			AddRes(index, typeof(Nightshade),"Nightshade", 1,"Vous n'avez pas assez de Nightshade.");
		...
		/*	index = AddCraft(typeof(MarkScroll),"Cycle","Marquage", 46.4, 96.4, typeof(BlankScroll), 1044377, 1, 1044378);
		 ...
		 craftItem.Mana = 4;
		   ...
		   index = AddCraft(typeof(StrangleScroll),"Mort","Étranglement", 46.4, 96.4, typeof(BlankScroll), 1044377, 1, 1044378);
			...
			index = AddCraft(typeof(BombardementScroll),"Arcane","Bombardement", 60.7, 110.7, typeof(BlankScroll), 1044377, 1, 1044378);
			AddRes(index, typeof(Bloodmoss),"Bloodmoss", 1,"Vous n'avez pas assez de Bloodmoss.");
			AddRes(index, typeof(Garlic),"Garlic", 1,"Vous n'avez pas assez de Garlic.");
			AddRes(index, typeof(SulfurousAsh),"SulfurousAsh", 1,"Vous n'avez pas assez de SulfurousAsh.");
			craftItem = CraftItems.GetAt(index);
...
*/
		...
		AddRes(index, typeof(DragonBlood), "DragonBlood", 10, "Vous n'avez pas assez de DragonBlood.");
			...
			*/
			...
			index = AddCraft(typeof(Missive), "Autres", "Missive", 15.0, 50.0, typeof(BlankScroll), 1044377, 1, 1044378);
			index = AddCraft(typeof(BookOfMasteries), "Autres", "Grand Livre du Barde", 15.0, 50.0, typeof(BlankScroll), 1044377, 20, 1044378);
			...
			index = AddCraft(typeof(GlassblowingBook), "Autres", "Connaissances Verre", 65, 100, typeof(BlankScroll), 1044377, 20, 1044378);

			index = AddCraft(typeof(SandMiningBook), "Autres", "Connaissances Sable", 65, 100, typeof(BlankScroll), 1044377, 20, 1044378);

			index = AddCraft(typeof(StoneMiningBook), "Autres", "Connaissances Granite", 65, 100, typeof(BlankScroll), 1044377, 20, 1044378);

			index = AddCraft(typeof(MasonryBook), "Autres", "Connaissances Pierre", 65, 100, typeof(BlankScroll), 1044377, 20, 1044378);

			index = AddCraft(typeof(GemMiningBook), "Autres", "Connaissances Gems", 65, 100, typeof(BlankScroll), 1044377, 20, 1044378);
