	...
	public class Mining : HarvestSystem
	{
		...
		private Mining()
		{
			...
			oreAndStone.BonusResources = new BonusHarvestResource[]
			{
                ...
                new BonusHarvestResource(100, .1, 1072562, typeof(BlueDiamant)),
				new BonusHarvestResource(100, .1, 1072567, typeof(DarkSapphire)),
				new BonusHarvestResource(100, .1, 1072570, typeof(EcruCitrine)),
				new BonusHarvestResource(100, .1, 1072564, typeof(FireRubis)),
				new BonusHarvestResource(100, .1, 1072566, typeof(PerfectEmeraude)),
		...
		{
			if (tool is Pickaxe && def == OreAndStone && 0.1 > Utility.RandomDouble() && HarvestMap.CheckMapOnHarvest(from, harvested, def) == null)
			{
