	...
	public class XmlQuestNPC : TalkingBaseCreature
	{
        ...
        public XmlQuestNPC(int gender) : base( AIType.AI_Melee, FightMode.None, 10, 1, 0.8, 3.0 )
        {
            ...
            if ( this.Female)
            {
                ...
                {
                    case 0: hat = new ChapeauPirate( Utility.RandomNeutralHue() );		break;
                    case 1: hat = new ChapeauPlume1( Utility.RandomNeutralHue() );	break;
                    case 2: hat = new Capuche();			break;
                    case 3: hat = new ChapeauToc( Utility.RandomNeutralHue() );			break;
                }
                AddItem( hat );
                Item pants = null;
                switch ( Utility.Random( 3 ) )
                {
                    case 0: pants = new Pantalon1( GetRandomHue() );	break;
                    case 1: pants = new LongPants( GetRandomHue() );	break;
                    case 2: pants = new Jupe( GetRandomHue() );		break;
                }
                AddItem( pants );
                Item shirt = null;
                switch ( Utility.Random( 7 ) )
                {
                    ...
                    case 5: shirt = new Chemise( GetRandomHue() );	break;
            ...
            else
            {
                ...
                switch ( Utility.Random( 5 ) )
                {
                    ...
                    case 1: shirt = new Surcoat( GetRandomHue() );		break;
                    case 2: shirt = new Tunic( GetRandomHue() );		break;
                    case 3: shirt = new Chemise( GetRandomHue() );	break;
            ...
            switch ( Utility.Random( 3 ) )
            {
                case 0: feet = new Bottes( Utility.RandomNeutralHue() );	break;
