    ...
    public class SBShipwright : SBInfo
    {
        ...
        public class InternalBuyInfo : List<GenericBuyInfo>
        {
            public InternalBuyInfo(Mobile m)
            {
				...
				Add(new GenericBuyInfo("Boat Paint", typeof(BoatPaint), 10000, 20, 4011, 396, new object[] { 396 }));
				Add(new GenericBuyInfo("Boat Paint", typeof(BoatPaint), 10000, 20, 4011, 516, new object[] { 516 }));
				Add(new GenericBuyInfo("Boat Paint", typeof(BoatPaint), 10000, 20, 4011, 1900, new object[] { 1900 }));
				Add(new GenericBuyInfo("Boat Paint", typeof(BoatPaint), 10000, 20, 4011, 251, new object[] { 251 }));
				Add(new GenericBuyInfo("Boat Paint", typeof(BoatPaint), 10000, 20, 4011, 246, new object[] { 246 }));
				Add(new GenericBuyInfo("Boat Paint", typeof(BoatPaint), 10000, 20, 4011, 2213, new object[] { 2213 }));
				Add(new GenericBuyInfo("Boat Paint", typeof(BoatPaint), 10000, 20, 4011, 36, new object[] { 36 }));
